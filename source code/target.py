...
class Target:
    ...
    def define_spawn_pos(self, size): # define the start pos and moving vel of target
    ...
    def animate(self): # change the frame of the target when needed
        t = time.time()
    ...
    def kill(self, targets): # remove target from the list
        targets.remove(self)
        return 1